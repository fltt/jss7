...
//        this.saveTrafficInFile();
    ...
    public void testSendRoutingInfoForSM() throws Exception {
        ...
        Server server = new Server(this.stack2, this, peer2Address, peer1Address) {
            public void onSendRoutingInfoForSMRequest(SendRoutingInfoForSMRequest sendRoutingInfoForSMInd) {
                ...
                ISDNAddressString additionalNumber = this.mapParameterFactory.createISDNAddressString(
                        AddressNature.subscriber_number, NumberingPlan.private_plan, "000111000");
                LocationInfoWithLMSI locationInfoWithLMSI = this.mapParameterFactory.createLocationInfoWithLMSI(
                        networkNodeNumber, lmsi, MAPExtensionContainerTest.GetTestExtensionContainer(), additionalNumberType,
                        additionalNumber);
    ...
    /**
     * TC-BEGIN + anyTimeInterrogationRequest TC-END + anyTimeInterrogationResponse
     */
    @Test(groups = { "functional.flow", "dialog" })
    ...
    /**
     * TC-BEGIN + InsertSubscriberDataRequest MAV V3 TC-END + InsertSubscriberDataRequestResponse
     */
    @Test(groups = { "functional.flow", "dialog" })
    ...
    /**
     * TC-BEGIN + InsertSubscriberDataRequest MAV V2 TC-END + InsertSubscriberDataRequestResponse
     */
    @Test(groups = { "functional.flow", "dialog" })
    ...
    /**
     * TC-BEGIN + SendRoutingInformation MAV V3 TC-END + SendRoutingInformationResponse
     */
    @Test(groups = { "functional.flow", "dialog" })
    ...
    /**
     * TC-BEGIN + SendRoutingInformation MAV V2 TC-END + SendRoutingInformationResponse
     */
    @Test(groups = { "functional.flow", "dialog" })
