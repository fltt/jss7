...
public class CAPFunctionalTest extends SccpHarness {
     ...
     *
     * TC-BEGIN + InitialDPRequest TC-CONTINUE + RequestReportBCSMEventRequest TC-CONTINUE + FurnishChargingInformationRequest
     * TC-CONTINUE + ApplyChargingRequest + ConnectRequest TC-CONTINUE + ContinueRequest TC-CONTINUE +
     * SendChargingInformationRequest TC-CONTINUE + EventReportBCSMRequest (OAnswer) TC-CONTINUE + ApplyChargingReportRequest
     * <call... waiting till DialogTimeout> TC-CONTINUE + ActivityTestRequest TC-CONTINUE + ActivityTestResponse TC-CONTINUE +
     * EventReportBCSMRequest (ODisconnect) TC-END (empty)
     */
    @Test(groups = { "functional.flow", "dialog" })
     ...
     *
     * TC-BEGIN + AssistRequestInstructionsRequest TC-CONTINUE + ResetTimerRequest TC-CONTINUE +
     * PromptAndCollectUserInformationRequest TC-CONTINUE + SpecializedResourceReportRequest TC-CONTINUE +
     * PromptAndCollectUserInformationResponse TC-END + CancelRequest
     */
    @Test(groups = { "functional.flow", "dialog" })
     ...
     *
     * TC-BEGIN + establishTemporaryConnection + callInformationRequest TC-END + callInformationReport
     */
    @Test(groups = { "functional.flow", "dialog" })
